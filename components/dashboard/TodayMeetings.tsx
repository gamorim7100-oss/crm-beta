  ...
  return (
    <div className="bg-bg-card border border-border rounded-xl p-5 shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-sm font-semibold text-white">Reuniões do Dia</h3>
      ...
      {meetings.length === 0 ? (
        <p className="text-sm text-gray-500 text-center py-6">Nenhuma reunião hoje</p>
      ) : (
          ...
          {meetings.map((meeting) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                {meeting.lead_name && (
                  <p className="text-xs text-gray-400">{meeting.lead_name}</p>
                )}
