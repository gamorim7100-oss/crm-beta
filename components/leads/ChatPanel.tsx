          ...
          {mediaPreview ? (
            <div className="flex-1 bg-[#1A2332] border border-emerald-500/20 rounded-lg p-2">
              ...
              <textarea
                ...
                rows={1}
                className="w-full bg-bg-card border border-white/10 rounded-lg px-2 py-1.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-emerald-400 resize-none"
              />
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                rows={1}
                className="w-full bg-bg-card border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-emerald-400 resize-none max-h-32"
              />
            </div>
          )}
          {!mediaPreview && (
