  ...
  return (
    <div className="flex h-[calc(100vh-8rem)]">
      ...
      {showConvertModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-bg-card border border-white/[0.06] rounded-xl w-full max-w-md p-6 shadow-xl">
            <h2 className="text-lg font-bold text-white mb-2">Converter em Cliente</h2>
            <p className="text-sm text-gray-400 mb-4">
              Deseja converter <strong className="text-white">{convertLead?.name || 'este lead'}</strong> em cliente?
