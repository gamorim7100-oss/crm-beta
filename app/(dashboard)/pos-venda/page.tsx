  ...
  if (loading) {
    return (
      <div className="space-y-4 p-6">
        <h1 className="text-xl font-bold text-white">Pós-Venda</h1>
    ...
    <div className="flex h-[calc(100vh-5rem)] gap-0">
      ...
      <div className={`flex flex-col ${selectedItem ? 'hidden lg:flex w-full lg:w-[380px]' : 'w-full'} border-r border-white/[0.06] shrink-0`}>
        <div className="flex items-center justify-between p-4 pb-3">
          <div>
            <h1 className="text-lg font-bold text-white">Pós-Venda</h1>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Buscar..."
              className="bg-bg-card border border-white/10 rounded-lg pl-8 pr-2.5 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-emerald-400 w-36"
            />
          </div>
        </div>
