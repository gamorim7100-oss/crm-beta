    ...
    if (field.type === 'select') {
      return (
        <select
          ...
          className={`w-full bg-bg-secondary border text-xs rounded px-2 py-1.5 focus:outline-none focus:border-emerald-400 ${
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="bg-bg-card border border-white/10 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-emerald-400 w-56"
          />
        </div>
      </div>
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium text-white truncate">{c.original.name}</span>
