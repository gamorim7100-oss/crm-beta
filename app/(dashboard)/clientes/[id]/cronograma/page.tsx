    ...
    <div className="space-y-6">
      ...
      <div className="bg-bg-card border border-white/[0.06] rounded-xl p-5 shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-lg font-bold text-white">{formatCurrency(yearTotal)}</p>
      ...
      <div className="bg-bg-card border border-white/[0.06] rounded-xl p-5 shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-sm font-semibold text-white">Cronograma de Pagamentos</h3>

          <select
            value={year}
            onChange={(e) => setYear(Number(e.target.value))}
            className="bg-bg-secondary text-gray-300 text-xs border border-white/10 rounded-lg px-3 py-1.5 focus:outline-none focus:border-emerald-400 ml-auto"
          >
